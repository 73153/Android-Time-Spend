...
public class IjoomerIntafyInviteUserForEventListFragment extends SmartFragment implements IntafyTagHolder,IjoomerSharedPreferences {
    ...
    public IjoomerIntafyInviteUserForEventListFragment(HashMap<String, String> selectedUserMap,HashMap<String, String> newSelectedUserMap,String IN_EVENT_ID) {
                ...
                if(getDataCount>1) {
                    if ((firstVisibleItem + visibleItemCount) >= totalItemCount && totalItemCount > 1) {
                        if (!intafyDirectoriesDataProvider.isCalling() && intafyDirectoriesDataProvider.hasNextPage()) {
                            ...
                            intafyDirectoriesDataProvider.getMembersList(connectedUserType,invitedUsers,networkId, networkType, connectedUserId, new WebCallListenerWithCacheInfo() {
