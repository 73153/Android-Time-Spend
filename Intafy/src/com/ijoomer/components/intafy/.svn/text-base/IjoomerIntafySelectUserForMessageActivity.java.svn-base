 ...
 *
 */
public class IjoomerIntafySelectUserForMessageActivity extends IjoomerIntafyMaster {

    private IjoomerIntafySelectUserForMessageListFragment intafyInviteUserListFragment;
    ...
    public void prepareViews() {
        ...
        intafyInviteUserListFragment = new IjoomerIntafySelectUserForMessageListFragment((HashMap<String,String>)getIntent().getSerializableExtra("IN_SELECTED_USER"));
