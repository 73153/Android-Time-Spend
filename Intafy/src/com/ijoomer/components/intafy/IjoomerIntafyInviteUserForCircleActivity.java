 ...
 *
 */
public class IjoomerIntafyInviteUserForCircleActivity extends IjoomerIntafyMaster {

    private IjoomerIntafyInviteUserForCircleListFragment intafyInviteUserListFragment;
    ...
    public void prepareViews() {
        ...
        intafyInviteUserListFragment = new IjoomerIntafyInviteUserForCircleListFragment((HashMap<String,String>)getIntent().getSerializableExtra("IN_SELECTED_USER"),(HashMap<String,String>)getIntent().getSerializableExtra("IN_NEW_SELECTED_USER"),IN_CIRCLE_ID);
