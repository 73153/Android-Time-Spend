...
public class IjoomerIntafyProfileFragment extends SmartFragment implements IntafyTagHolder {
    ...
    private IjoomerTextView txtField3Label;
    private IjoomerTextView txtField3Value;
    private LinearLayout lnrField1;
    private LinearLayout lnrField2;
    private LinearLayout lnrField3;
    public IjoomerIntafyProfileFragment(JSONArray data) {
        this.data=data;
    }
    ...
    public int setLayoutId() {
        return R.layout.ijoomer_intafy_profile_details_fragment;
    }
    ...
    public void initComponents(View currentView) {
        ...
        lnrField3 = (LinearLayout) currentView.findViewById(R.id.lnrField3);
        ...
        txtField3Label = (IjoomerTextView) currentView.findViewById(R.id.txtField3Label);
        txtField3Value = (IjoomerTextView) currentView.findViewById(R.id.txtField3Value);
    ...
    private void setProfileField(){
        ...
        try{
            ...
            if(data.length()>2){
                txtField3Label.setText(data.getJSONObject(2).getString(CAPTION));
                if(data.getJSONObject(2).getString(CAPTION).toLowerCase().contains("date")){
                    txtField3Value.setText(IjoomerUtilities.convertDateStringFormat(data.getJSONObject(2).getString(VALUE), "yyyy-MM-dd", IjoomerApplicationConfiguration.dateFormat));
                }else{
                    txtField3Value.setText(data.getJSONObject(2).getString(VALUE));
                }
                lnrField3.setVisibility(View.VISIBLE);
            }
        }catch (Throwable e){
            e.printStackTrace();
        }
