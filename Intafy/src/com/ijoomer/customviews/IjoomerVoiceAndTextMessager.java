...
public class IjoomerVoiceAndTextMessager extends LinearLayout {
    ...
    private void init(AttributeSet attrs) {
        ...
        if (attrs == null) {
            ...
            smileyButtonImageResourceId = R.drawable.ic_launcher;
            ...
            smileyButtonImageResourceId = attrs.getAttributeResourceValue(namespace, "smiley_image_icon", R.drawable.ic_launcher);
