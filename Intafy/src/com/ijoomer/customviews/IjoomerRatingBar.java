...
public class IjoomerRatingBar extends LinearLayout {
	...
	private void init(AttributeSet attrs) {
		...
		if (attrs == null) {
			filledStarResourceId = R.drawable.ic_launcher;
			emptyStarResourceId = R.drawable.ic_launcher;
			halfFilledStarResourceId = R.drawable.ic_launcher;
			starRating = 0;
			...
			filledStarResourceId = attrs.getAttributeResourceValue(namespace, "star_filled", R.drawable.ic_launcher);
			emptyStarResourceId = attrs.getAttributeResourceValue(namespace, "star_empty", R.drawable.ic_launcher);
			halfFilledStarResourceId = attrs.getAttributeResourceValue(namespace, "star_half", R.drawable.ic_launcher);
