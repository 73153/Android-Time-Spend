 ...
 * 
 */
public class IjoomerEditText2 extends EditText implements KeyListener {
	...
	public IjoomerEditText2(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		init(context);
	}

	public IjoomerEditText2(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(context);
	}

	public IjoomerEditText2(Context context) {
		super(context);
		init(context);
	}
