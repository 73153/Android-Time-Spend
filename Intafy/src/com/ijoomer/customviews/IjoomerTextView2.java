 ...
 * 
 */
public class IjoomerTextView2 extends TextView {
    ...
    public IjoomerTextView2(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init(context);
    }

    public IjoomerTextView2(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public IjoomerTextView2(Context context) {
        super(context);
