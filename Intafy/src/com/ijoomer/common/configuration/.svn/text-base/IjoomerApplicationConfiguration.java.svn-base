...
public abstract class IjoomerApplicationConfiguration implements IjoomerSharedPreferences {
    ...
    public static String fontNameWithPathDark;
	...
	public static void setDefaultConfiguration(Context context) {
		try {
			if (twitterConsumerKey == null) {
				...
				fontNameWithPathDark = context.getString(R.string.font_name_with_path_dark);
				...
				if (IjoomerGlobalConfiguration.getJomsocialVersion().equals(IjoomerGlobalConfiguration.JOMVERSION_V30)) {
					IjoomerScreenHolder.originalScreens.put("Registration", "com.ijoomer.intafy.src.IjoomerRegistrationStep1Activity_v30");
    ...
    public static String getFontNameWithPathDark() {
        return fontNameWithPathDark;
    }
    ...
    public static void setFontNameWithPathDark(String fontNameWithPathDark) {
        IjoomerApplicationConfiguration.fontNameWithPathDark = fontNameWithPathDark;
    }
