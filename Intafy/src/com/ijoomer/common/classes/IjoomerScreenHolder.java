	...
	public static HashMap<String, String> originalScreens = new HashMap<String, String>() {
		{
			...
			put("Login", "com.ijoomer.intafy.src.IjoomerLoginActivity");
			put("Registration", "com.ijoomer.intafy.src.IjoomerRegistrationStep1Activity");
			put("Home", "com.ijoomer.intafy.src.IjoomerHomeActivity");
			...
			put("DisplayAsMenu", "com.ijoomer.intafy.src.IjoomerMenuActivity");
