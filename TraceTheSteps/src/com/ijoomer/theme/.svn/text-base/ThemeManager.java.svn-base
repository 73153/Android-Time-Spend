    ...
    public void setTheme(Activity currentActivity){
        ...
        if(themeId>0){
            ...
            if(getLastActivity()!=null){
                if(themeId==0){
                    if(getLastActivity().getClass().getSimpleName().toLowerCase().contains(JOM_ACTIVITY_IDENTIFIER)){
                        themeId = getLastActivity().getResources().getIdentifier(JOM_ACTIVITY_IDENTIFIER+"_theme","style",getLastActivity().getPackageName());
                        setLayout(currentActivity,JOM_ACTIVITY_IDENTIFIER);
                    }else if(getLastActivity().getClass().getSimpleName().toLowerCase().contains(ICMS_ACTIVITY_IDENTIFIER)){
                        themeId = getLastActivity().getResources().getIdentifier(ICMS_ACTIVITY_IDENTIFIER+"_theme","style",getLastActivity().getPackageName());
                        setLayout(currentActivity,ICMS_ACTIVITY_IDENTIFIER);
                    }else if(getLastActivity().getClass().getSimpleName().toLowerCase().contains(SOBIPRO_ACTIVITY_IDENTIFIER)){
                        themeId = getLastActivity().getResources().getIdentifier(SOBIPRO_ACTIVITY_IDENTIFIER+"_theme","style",getLastActivity().getPackageName());
                        setLayout(currentActivity,SOBIPRO_ACTIVITY_IDENTIFIER);
                    }else if(getLastActivity().getClass().getSimpleName().toLowerCase().contains(K2_ACTIVITY_IDENTIFIER)){
                        themeId = getLastActivity().getResources().getIdentifier(K2_ACTIVITY_IDENTIFIER+"_theme","style",getLastActivity().getPackageName());
                        setLayout(currentActivity,K2_ACTIVITY_IDENTIFIER);
                    }else{
