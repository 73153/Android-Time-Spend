	...
	public static HashMap<String, String> originalScreens = new HashMap<String, String>() {
		{
			...
			put("Login", "com.ijoomer.tracethesteps.src.IjoomerLoginActivity");
            ...
            put("IpropertySeachForm", "com.ijoomer.components.iproperty.IPropertySearchActivity");
            put("IpropertyFavouriteList", "com.ijoomer.components.iproperty.IPropertyFavouriteListActivity");
	...
	public static HashMap<String, String> aliasScreens = new HashMap<String, String>() {
		{
            ...
            put("IPropertySearchActivity", "IpropertySeachForm");
            put("IPropertyFavouriteListActivity", "IpropertyFavouriteList");
