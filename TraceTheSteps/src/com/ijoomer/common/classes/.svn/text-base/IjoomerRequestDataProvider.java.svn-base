...
import com.ijoomer.components.iproperty.IPropertyTagHolder;
 ...
 * 
 */
public class IjoomerRequestDataProvider implements IjoomerKeys,IjoomerSharedPreferences,IPropertyTagHolder {
