...
public class ViewHolder {
    ...
    /*
     * IProperty Comment List
     */
    public LinearLayout iPropertylnrCommentBottom;
    public ImageView iPropertyimgCommentEdit;
    public ImageView iPropertyimgCommentRemove;
    public ImageView iPropertyimgCommentLike;
    public ImageView iPropertyimgCommentDislike;
    public IjoomerTextView iPropertytxtCommentUser;
    public IjoomerTextView iPropertytxtCommentDate;
    public IjoomerTextView iPropertytxtComment;
    public IjoomerTextView iPropertytxtCommentCount;
    
    /*
     * IProperty Search Result List
     */
    public LinearLayout iPropertylnrProperty;
    public ImageView iPropertyimgSearchCategoryImage;
    public ImageView iPropertyimgFavouriteRemove;
    public IjoomerTextView iPropertytxtSearchCategoryAddress;
    public IjoomerTextView iPropertytxtSearchCategoryTitle;
