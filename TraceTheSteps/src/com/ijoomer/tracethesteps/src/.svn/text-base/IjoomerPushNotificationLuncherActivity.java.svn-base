                ...
                if(responseCode ==200){
                    ...
                    try{
                        if (IN_PUSH_TYPE.equals("replaycomment")) {
                            ...
                            try{
                                gotoIntent.putExtra("IN_USERID", ((JSONObject)data2).getJSONObject("data").getJSONObject("content_data").has("id") ? ((JSONObject)data2).getJSONObject("data").getJSONObject("content_data").getString("id") : "0");
                            }catch (Exception e){
