...
//			fileName = "record" + mediaStorageDir.listFiles().length;
//		} else {
//			fileName = "record" + 1;
//		}

        return mediaStorageDir.getAbsolutePath() + File.separator + "iarecord" + ".3gp";
    }
    ...
    private SmartListAdapterWithHolder getEmojisGridAdapter(){
        ...
        SmartListAdapterWithHolder adapterWithHolder = new SmartListAdapterWithHolder(context, R.layout.ijoomer_message_emojis_grid_item, emojisList,
                new ItemView() {
                    @Override
