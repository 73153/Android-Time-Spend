package com.eosos.common.configuration;
...
import com.eosos.common.classes.IjoomerScreenHolder;
...
public class IjoomerGlobalConfiguration extends IjoomerResponseValidator implements IjoomerSharedPreferences {
    ...
    private static ArrayList<String> sliderList;
    ...
    public static ArrayList<String> getSliderList() {
        sliderList = new ArrayList<String>();
        if(SmartApplication.REF_SMART_APPLICATION.readSharedPreferences().getString(IjoomerSharedPreferences.SP_IJOOMER_SLIDE_BAR1_REQUIRED, "").length()>0){
            sliderList.add(SmartApplication.REF_SMART_APPLICATION.readSharedPreferences().getString(IjoomerSharedPreferences.SP_IJOOMER_SLIDE_BAR1_REQUIRED, ""));
        }
        if(SmartApplication.REF_SMART_APPLICATION.readSharedPreferences().getString(IjoomerSharedPreferences.SP_IJOOMER_SLIDE_BAR2_REQUIRED, "").length()>0){
            sliderList.add(SmartApplication.REF_SMART_APPLICATION.readSharedPreferences().getString(IjoomerSharedPreferences.SP_IJOOMER_SLIDE_BAR2_REQUIRED, ""));
        }
        if(SmartApplication.REF_SMART_APPLICATION.readSharedPreferences().getString(IjoomerSharedPreferences.SP_IJOOMER_SLIDE_BAR3_REQUIRED, "").length()>0){
            sliderList.add(SmartApplication.REF_SMART_APPLICATION.readSharedPreferences().getString(IjoomerSharedPreferences.SP_IJOOMER_SLIDE_BAR3_REQUIRED, ""));
        }
        if(SmartApplication.REF_SMART_APPLICATION.readSharedPreferences().getString(IjoomerSharedPreferences.SP_IJOOMER_SLIDE_BAR4_REQUIRED, "").length()>0){
            sliderList.add(SmartApplication.REF_SMART_APPLICATION.readSharedPreferences().getString(IjoomerSharedPreferences.SP_IJOOMER_SLIDE_BAR4_REQUIRED, ""));
        }
        if(SmartApplication.REF_SMART_APPLICATION.readSharedPreferences().getString(IjoomerSharedPreferences.SP_IJOOMER_SLIDE_BAR5_REQUIRED, "").length()>0){
            sliderList.add(SmartApplication.REF_SMART_APPLICATION.readSharedPreferences().getString(IjoomerSharedPreferences.SP_IJOOMER_SLIDE_BAR5_REQUIRED, ""));
        }
        return sliderList;
    }
	...
	public void loadGlobalConfiguration(final WebCallListener target) {
		...
		new AsyncTask<Void, Void, Void>() {
			...
			protected Void doInBackground(Void... params) {
				...
				if (validateResponse(iw.getJsonObject())) {
					...
					try {
                        ...
                        try {
                            if (object.has("IJOOMER_SLIDE_BAR1_REQUIRED") && object.getString("IJOOMER_SLIDE_BAR1_REQUIRED").trim().length()>0) {
                                SmartApplication.REF_SMART_APPLICATION.writeSharedPreferences(IjoomerSharedPreferences.SP_IJOOMER_SLIDE_BAR1_REQUIRED,object.getString("IJOOMER_SLIDE_BAR1_REQUIRED"));
                            }
                            if (object.has("IJOOMER_SLIDE_BAR2_REQUIRED") && object.getString("IJOOMER_SLIDE_BAR2_REQUIRED").trim().length()>0) {
                                SmartApplication.REF_SMART_APPLICATION.writeSharedPreferences(IjoomerSharedPreferences.SP_IJOOMER_SLIDE_BAR2_REQUIRED,object.getString("IJOOMER_SLIDE_BAR2_REQUIRED"));
                            }
                            if (object.has("IJOOMER_SLIDE_BAR3_REQUIRED") && object.getString("IJOOMER_SLIDE_BAR3_REQUIRED").trim().length()>0) {
                                SmartApplication.REF_SMART_APPLICATION.writeSharedPreferences(IjoomerSharedPreferences.SP_IJOOMER_SLIDE_BAR3_REQUIRED,object.getString("IJOOMER_SLIDE_BAR3_REQUIRED"));
                            }
                            if (object.has("IJOOMER_SLIDE_BAR4_REQUIRED") && object.getString("IJOOMER_SLIDE_BAR4_REQUIRED").trim().length()>0) {
                                SmartApplication.REF_SMART_APPLICATION.writeSharedPreferences(IjoomerSharedPreferences.SP_IJOOMER_SLIDE_BAR4_REQUIRED,object.getString("IJOOMER_SLIDE_BAR4_REQUIRED"));
                            }
                            if (object.has("IJOOMER_SLIDE_BAR5_REQUIRED") && object.getString("IJOOMER_SLIDE_BAR5_REQUIRED").trim().length()>0) {
                                SmartApplication.REF_SMART_APPLICATION.writeSharedPreferences(IjoomerSharedPreferences.SP_IJOOMER_SLIDE_BAR5_REQUIRED,object.getString("IJOOMER_SLIDE_BAR5_REQUIRED"));
                            }
                        } catch (Exception e) {
                            e.printStackTrace();
                        }
			...
			protected void onPostExecute(Void result) {
				...
				// if
				// (!SmartApplication.REF_SMART_APPLICATION.readSharedPreferences().getBoolean(SP_ICON_PRELOADER,
				// false)) {
				// SmartApplication.REF_SMART_APPLICATION.writeSharedPreferences(SP_ICON_PRELOADER,
				// true);
				// loadAllIcons(target);
				// } else {
