package com.eosos.custom.interfaces;
...
public interface IjoomerSharedPreferences {
	...
	public static String SP_CLUBS_LOADER_DATE="clubsLoaderDate";
    ...
    public static String SP_IJOOMER_SLIDE_BAR1_REQUIRED = "IJOOMER_SLIDE_BAR1_REQUIRED";
    public static String SP_IJOOMER_SLIDE_BAR2_REQUIRED = "IJOOMER_SLIDE_BAR2_REQUIRED";
    public static String SP_IJOOMER_SLIDE_BAR3_REQUIRED = "IJOOMER_SLIDE_BAR3_REQUIRED";
    public static String SP_IJOOMER_SLIDE_BAR4_REQUIRED = "IJOOMER_SLIDE_BAR4_REQUIRED";
    public static String SP_IJOOMER_SLIDE_BAR5_REQUIRED = "IJOOMER_SLIDE_BAR5_REQUIRED";
