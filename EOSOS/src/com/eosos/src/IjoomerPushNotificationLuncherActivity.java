...
import com.eosos.custom.interfaces.IjoomerKeys;
				...
				if (responseCode == 200) {
					try {
						if (IN_PUSH_TYPE.equals("replaycomment")) {
							...
							gotoIntent.setClassName(IjoomerPushNotificationLuncherActivity.this, "com.eosos.components.jomsocial.JomWallOrActivityDetailActivity");
						...
						if (IN_PUSH_TYPE.equals("walllike")) {
							...
							gotoIntent = new Intent();
							gotoIntent.setClassName(IjoomerPushNotificationLuncherActivity.this, "com.eosos.components.jomsocial.JomProfileActivity");
							try {
							...
							gotoIntent = new Intent();
							gotoIntent.setClassName(IjoomerPushNotificationLuncherActivity.this, "com.eosos.components.jomsocial.JomFriendListActivity");
						} else if (IN_PUSH_TYPE.equals("message")) {
							gotoIntent = new Intent();
							gotoIntent.setClassName(IjoomerPushNotificationLuncherActivity.this, "com.eosos.components.jomsocial.JomMessageActivity");
							...
							if (groupData.getString("type").equals("group")) {
								...
								if (IjoomerGlobalConfiguration.getJomsocialVersion().equals(IjoomerGlobalConfiguration.JOMVERSION_V30)) {
									gotoIntent.setClassName(IjoomerPushNotificationLuncherActivity.this, "com.eosos.components.jomsocial.JomGroupDetailsActivity_v30");
								} else {
									gotoIntent.setClassName(IjoomerPushNotificationLuncherActivity.this, "com.eosos.components.jomsocial.JomGroupDetailsActivity");
								}
								gotoIntent.putExtra("IN_USERID", "0");
								...
								gotoIntent = new Intent();
								gotoIntent.setClassName(IjoomerPushNotificationLuncherActivity.this, "com.eosos.components.jomsocial.JomGroupDiscussionDetailsActivity");
								...
								JSONObject groupDetails = new JSONObject(groupData.getString("groupdetail"));
								gotoIntent = new Intent();
								gotoIntent.setClassName(IjoomerPushNotificationLuncherActivity.this, "com.eosos.components.jomsocial.JomGroupAnnouncementDetailsActivity");
								...
								gotoIntent = new Intent();
								gotoIntent.setClassName(IjoomerPushNotificationLuncherActivity.this, "com.eosos.components.jomsocial.JomAlbumsDetailsActivity");
								...
								gotoIntent = new Intent();
								gotoIntent.setClassName(IjoomerPushNotificationLuncherActivity.this, "com.eosos.components.jomsocial.JomVideoDetailsActivity");
								...
								gotoIntent = new Intent();
								if (IjoomerGlobalConfiguration.getJomsocialVersion().equals(IjoomerGlobalConfiguration.JOMVERSION_V30)) {
									gotoIntent.setClassName(IjoomerPushNotificationLuncherActivity.this, "com.eosos.components.jomsocial.JomEventDetailsActivity_v30");
								} else {
									gotoIntent.setClassName(IjoomerPushNotificationLuncherActivity.this, "com.eosos.components.jomsocial.JomEventDetailsActivity");
								}
							...
							gotoIntent = new Intent();
							if (IjoomerGlobalConfiguration.getJomsocialVersion().equals(IjoomerGlobalConfiguration.JOMVERSION_V30)) {
								gotoIntent.setClassName(IjoomerPushNotificationLuncherActivity.this, "com.eosos.components.jomsocial.JomEventDetailsActivity_30");
							}else{
								gotoIntent.setClassName(IjoomerPushNotificationLuncherActivity.this, "com.eosos.components.jomsocial.JomEventDetailsActivity");
							}
							...
							gotoIntent = new Intent();
							gotoIntent.setClassName(IjoomerPushNotificationLuncherActivity.this, "com.eosos.components.jomsocial.JomPhotoDetailsActivity");
