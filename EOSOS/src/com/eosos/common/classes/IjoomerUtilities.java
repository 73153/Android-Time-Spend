...
import com.eosos.custom.interfaces.CustomClickListner;
import com.eosos.custom.interfaces.IjoomerClickListner;
import com.eosos.custom.interfaces.IjoomerSharedPreferences;
import com.eosos.custom.interfaces.ReportListner;
import com.eosos.custom.interfaces.SelectImageDialogListner;
import com.eosos.custom.interfaces.ShareListner;
import com.eosos.customviews.IjoomerButton;
import com.eosos.customviews.IjoomerCheckBox;
import com.eosos.customviews.IjoomerDataPickerView;
...
public class IjoomerUtilities implements IjoomerSharedPreferences {
    ...
    public static void getCustomConfirmRatingAndFacebookShareDialog(final String ratingText, final String facebookText,final CustomAlertMagnatic target) {
        mSmartAndroidActivity.runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                final Dialog dialog = new Dialog(mSmartAndroidActivity, android.R.style.Theme_Translucent_NoTitleBar);
                dialog.setContentView(R.layout.eosos_rating_and_facebook_confirm_dialog);

                IjoomerTextView txtMessageRating = (IjoomerTextView) dialog.findViewById(R.id.txtMessageRating);
                IjoomerTextView txtMessageFacebook = (IjoomerTextView) dialog.findViewById(R.id.txtMessageFacebook);
                txtMessageRating.setText(ratingText);
                txtMessageFacebook.setText(facebookText);
                final IjoomerTextView txtYes = (IjoomerTextView) dialog.findViewById(R.id.txtYes);
                final IjoomerTextView txtNo = (IjoomerTextView) dialog.findViewById(R.id.txtNo);
                txtYes.setTextColor(mSmartAndroidActivity.getResources().getColor(R.color.txt_color));
                txtNo.setTextColor(mSmartAndroidActivity.getResources().getColor(R.color.txt_color));

                txtYes.setOnClickListener(new OnClickListener() {

                    @Override
                    public void onClick(View v) {
                        txtYes.setTextColor(mSmartAndroidActivity.getResources().getColor(R.color.red));
                        target.PositiveMethod();
                        dialog.dismiss();
                    }
                });
                txtNo.setOnClickListener(new OnClickListener() {
                    ...
                    @Override
                    public void onClick(View v) {
                        txtNo.setTextColor(mSmartAndroidActivity.getResources().getColor(R.color.red));
                        target.NegativeMethod();
                        dialog.dismiss();
                    }
                });
...
//	}
	...
	public static void addToNotificationBar(String ticker, String title, String message) {
		...
		int icon = R.drawable.ijoomer_launcher;
