...
public class IjoomerRatingBar extends LinearLayout {
	...
	private void init(AttributeSet attrs) {
		...
		if (attrs == null) {
			filledStarResourceId = R.drawable.rating_filled;
			emptyStarResourceId = R.drawable.rating;
			halfFilledStarResourceId = R.drawable.rating_filled_half;
			starRating = 0;
			...
			filledStarResourceId = attrs.getAttributeResourceValue(namespace, "star_filled", R.drawable.rating_filled);
			emptyStarResourceId = attrs.getAttributeResourceValue(namespace, "star_empty", R.drawable.rating);
			halfFilledStarResourceId = attrs.getAttributeResourceValue(namespace, "star_half", R.drawable.rating_filled_half);
