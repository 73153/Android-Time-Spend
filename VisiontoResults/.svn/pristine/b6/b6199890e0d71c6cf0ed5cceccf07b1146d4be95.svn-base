package com.ijoomer.tips.menubuilder;
...
public abstract class MenuDrawer extends ViewGroup {
	...
	/**
	 * Indicates whether to use {@link android.view.View#setTranslationX(float)} when
	 * positioning views.
	 */
	...
	/**
	 * Temporary {@link android.graphics.Rect} used for deciding whether the view should be
	...
	/**
	 * Indicates whether to use {@link android.view.View#LAYER_TYPE_HARDWARE} when animating
	 * the drawer.
	 */
	...
	/**
	 * Enables or disables the user of {@link android.view.View#LAYER_TYPE_HARDWARE} when
	 * animations views.
	 *
	 * @param enabled
