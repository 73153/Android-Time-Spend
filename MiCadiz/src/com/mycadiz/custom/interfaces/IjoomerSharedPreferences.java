package com.mycadiz.custom.interfaces;
...
public interface IjoomerSharedPreferences {
    ...
    public static String SP_LAST_REQUEST_TIME = "lastRequestTime";
    public static String SP_ALLIMAGEDOWNLOADED = "allImageDownloaded";
	 ...
	 */
    public static String SP_LNAGUAGE = "language";
    ...
    */
     ...
     * SobiPro Contact
     */
    public static String SP_SOBIPRO_CONTACT_NAME = "yourName";
    public static String SP_SOBIPRO_CONTACT_PHONE_NUMBER = "phoneNumber";
    public static String SP_SOBIPRO_CONTACT_EMAIL = "email";
