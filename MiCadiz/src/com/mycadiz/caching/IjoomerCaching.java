...
import com.mycadiz.common.classes.CoreCachingConstants;
...
public final class IjoomerCaching extends CoreCachingConstants {
    ...
    public ArrayList<HashMap<String, String>> getDataFromCache(String tableName) {
        try {
            ...
            }while (sd.isDbLockedByOtherThreads());
                    ...
                    if (IjoomerCachingConstants.unNormalizeFields.containsKey(key)) {
                        if(key.equals("field")) {
                            try {
                                ...
                                createSubTable.cacheData(new JSONArray(data.getString(key)), false, "entryFields");
                            } catch (Exception e) {
                                e.printStackTrace();
                            }
                        }
