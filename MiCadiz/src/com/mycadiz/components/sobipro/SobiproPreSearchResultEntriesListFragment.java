 ...
 *
 */
public class SobiproPreSearchResultEntriesListFragment extends SmartFragment implements SobiproTagHolder {
    ...
    public SobiproPreSearchResultEntriesListFragment(String IN_SECTION_ID, String IN_KEYWORD, int IN_POS, String IN_PRIVIOUS_ACTIVITY) {
    ...
    public void prepareViews(View currentView) {
        ...
        if(Boolean.parseBoolean(getString(R.string.local_database))){
            ...
            tableName=SOBIPROPRESEARCHENTRIES;
        }
        getEntries();
    }
                ...
                if(!Boolean.parseBoolean(getString(R.string.local_database))){
                    if (listData.size()>1 && (firstVisibleItem + visibleItemCount) >= totalItemCount && totalItemCount > 1) {
                        if (!categoriesDataProvider.isCalling() && categoriesDataProvider.hasNextPage()) {
                            listFooterVisible();
                            categoriesDataProvider.getPreSearchEntries(tableName, IN_SECTION_ID, IN_KEYWORD, ((SmartActivity)getActivity()).getLatitude(),((SmartActivity)getActivity()).getLongitude(),new WebCallListenerWithCacheInfo() {
    ...
    private void getEntries() {
        if(Boolean.parseBoolean(getString(R.string.local_database))){
            ArrayList<HashMap<String,String>> entries  = categoriesDataProvider.getPreSearchEntriesFromDB(IN_KEYWORD,IN_SECTION_ID);
            ...
            categoriesDataProvider.getPreSearchEntries(tableName, IN_SECTION_ID, IN_KEYWORD,((SmartActivity)getActivity()).getLatitude(),((SmartActivity)getActivity()).getLongitude(), new WebCallListenerWithCacheInfo() {
                ...
                public void onCallComplete(final int responseCode, String errorMessage, ArrayList<HashMap<String, String>> data1, Object data2, int pageNo, int pageLimit,
                    ...
                    try {
                        if (responseCode == 200) {
                            if (data1 != null && data1.size()>0) {
                                entryListData = (ArrayList<HashMap<String, String>>) data2;
                            ...
                            public void onClick(View view) {
                                try {
                                    ...
                                    ((SmartActivity) getActivity()).loadNew(SobiproEntryDetailActivity.class, getActivity(), false, "IN_CAT_ID", "0", "IN_ENTRY_ID_ARRAY", ID_ARRAY,
                                            "IN_ENTRY_INDEX", position, "IN_TABLE", tableName, "IN_POS", IN_POS, "IN_PAGELAYOUT", "", "IN_FEATUREDFIRST", "No", "IN_PRIVIOUS_ACTIVITY", IN_PRIVIOUS_ACTIVITY);
                                } catch (Exception e) {
                                    e.printStackTrace();
                                }
                            }
                        ...
                        holder.imgEntryIcon.setOnClickListener(new OnClickListener() {
                            ...
                            public void onClick(View view) {
                                try {
                                    prepareIDS();
                                    ((SmartActivity) getActivity()).loadNew(SobiproEntryDetailActivity.class, getActivity(), false, "IN_CAT_ID", "0", "IN_ENTRY_ID_ARRAY", ID_ARRAY,
                                            "IN_ENTRY_INDEX", position, "IN_TABLE", tableName, "IN_POS", IN_POS, "IN_PAGELAYOUT", "", "IN_FEATUREDFIRST", "No", "IN_PRIVIOUS_ACTIVITY", IN_PRIVIOUS_ACTIVITY==null?"":IN_PRIVIOUS_ACTIVITY);
                                } catch (Exception e) {
                                    e.printStackTrace();
                                }
                            }
                        ...
                        holder.txtAddress.setOnClickListener(new OnClickListener() {
                            ...
                            /*try {
                                ...
                                ((SmartActivity) getActivity()).loadNew(SobiproMapActivity.class, getActivity(), false, "IN_ENTRY_ID_ARRAY", ID_ARRAY, "IN_TABLE", tableName, "IN_POS",
                                        IN_POS, "IN_PAGELAYOUT", "", "IN_PRIVIOUS_ACTIVITY", IN_PRIVIOUS_ACTIVITY);
                            } catch (Exception e) {
                                e.printStackTrace();
                            }*/
                            }
    ...
    private void populateMap() {
        ...
        try {
            ...
            googleMap.moveCamera(CameraUpdateFactory.zoomBy(6));
